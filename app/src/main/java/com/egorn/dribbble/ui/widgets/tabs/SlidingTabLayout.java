package com.egorn.dribbble.ui.widgets.tabs;/*
 ...
 * alternative is via the {@link com.egorn.dribbble.ui.widgets.tabs.SlidingTabLayout.TabColorizer} interface which provides you complete control over
...
public class SlidingTabLayout extends HorizontalScrollView {
    ...
    /**
     * Set the custom {@link com.egorn.dribbble.ui.widgets.tabs.SlidingTabLayout.TabColorizer} to be used.
     * <p/>
    ...
    /**
     * Set the {@link android.support.v4.view.ViewPager.OnPageChangeListener}. When using {@link com.egorn.dribbble.ui.widgets.tabs.SlidingTabLayout} you are
     ...
     */
    public void setCustomTabView(int layoutResId, int imageViewId, int textViewId) {
...
//        textView.setTypeface(Typeface.DEFAULT_BOLD);
    ...
    private void populateTabStrip() {
        ...
        for (int i = 0; i < adapter.getCount(); i++) {
            ...
            if (mTabViewLayoutId != 0) {
                ...
                int padding = (int) (TAB_VIEW_PADDING_DIPS * getResources().getDisplayMetrics().density) / 2;
            ...
            if (drawables != null && drawables.length >= i) {
                tabImageView.setImageDrawable(getContext().getResources().getDrawable(drawables[i]));
            }
    ...
    public void setDrawableArray(int... drawables) {
    ...
    private void register() {
        if (mViewPager != null) {
            PagerAdapter newAdapter = mViewPager.getAdapter();
            if (newAdapter != null) {
                unregister();
                observer.adapter = newAdapter;
    ...
    private void unregister() {
        if (observer.adapter != null) {
            observer.adapter.unregisterDataSetObserver(observer);
        }
    }

    /**
     * Allows complete control over the colors drawn in the tab layout. Set with
     * {@link #setCustomTabColorizer(com.egorn.dribbble.ui.widgets.tabs.SlidingTabLayout.TabColorizer)}.
     */
